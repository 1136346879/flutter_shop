...
class imagePickerPagehome extends StatefulWidget {
  imagePickerPagehome({Key key, this.title}) : super(key: key);
...
class _MyHomePageState extends State<imagePickerPagehome> {
  File _imageFile;
