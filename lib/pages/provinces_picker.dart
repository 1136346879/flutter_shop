 ...
 * 省市区三级联动弹框
 */
class ProvincesPicker {
  static void showCityPicker(
    BuildContext context,bool operator, {
...
final bool operator;
  ...
  @override
  bool get barrierDismissible => operatorData;//点击弹框外部阴影是否消失

  AnimationController _animationController;

  get operatorData => operator;
